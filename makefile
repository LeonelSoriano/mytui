...
SOURCES=./src/until.c  ./src/mytui_config.c ./src/mytui.c ./src/mytui_buffer.c ./src/mytui_widget.c ./src/mytui_std_conf.c ./src/mytui_container_tui.c ./src/mytui_mouse_manager.c ./src/mytui_animation.c ./src/mytui_debug_system.c ./src/mytui_logger.c ./src/mytui_active_manager.c
